...
{
    public class AbpSuiteDbMigrationService : ITransientDependency
    {
        public ILogger<AbpSuiteDbMigrationService> Logger { get; set; }
        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IAbpSuiteDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public AbpSuiteDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IAbpSuiteDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<AbpSuiteDbMigrationService>.Instance;
        }
