    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuiteDataType", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");

            migrationBuilder.CreateTable(
                name: "SuiteEntityModels",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuiteEntityModels", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuiteEnumType", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuiteProjects", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuiteTemplates", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                name: "SuiteEntityModelProperties",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Code = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuiteEntityModelProperties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SuiteEntityModelProperties_SuiteEntityModels_EntityModelId",
                        column: x => x.EntityModelId,
                        principalTable: "SuiteEntityModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuiteEnumTypeProperty", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SuiteEnumTypeProperty_SuiteEnumType_EnumTypeId",
                        column: x => x.EnumTypeId,
                        principalTable: "SuiteEnumType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuiteTemplateDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SuiteTemplateDetails_SuiteTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "SuiteTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuiteEntityModelProperties_EntityModelId",
                table: "SuiteEntityModelProperties",
                column: "EntityModelId");

            migrationBuilder.CreateIndex(
                name: "IX_SuiteEntityModels_Code",
                table: "SuiteEntityModels",
                column: "Code");

            migrationBuilder.CreateIndex(
                name: "IX_SuiteEnumType_Code",
                table: "SuiteEnumType",
                column: "Code");

            migrationBuilder.CreateIndex(
                name: "IX_SuiteEnumTypeProperty_Code",
                table: "SuiteEnumTypeProperty",
                column: "Code");

            migrationBuilder.CreateIndex(
                name: "IX_SuiteEnumTypeProperty_EnumTypeId",
                table: "SuiteEnumTypeProperty",
                column: "EnumTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SuiteTemplateDetails_TemplateId",
