...
public class GeneratorEntityModelResult
{
    public GeneratorEntityModelResult()
    {
        Properties = new List<GeneratorEntityModelPropertyResult>();
    }
    /// <summary>
    ///  实体Id
    /// </summary>
    ...
    /// 实体模型属性集合
    /// </summary>
    public List<GeneratorEntityModelPropertyResult> Properties { get; set; }
}